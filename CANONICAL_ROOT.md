...
current_spec: docs/design/v3/ROLL20_TABLE_SPEC.md   # 요소 전수 + 결정 기록 D1~D220, 로드맵 R1~R85
...
- `tests/client/*.test.ts` — 단위 353개. `scripts/capture-client-*.mjs` — 브라우저 E2E 17개, 증거는
...
3. `docs/HANDOFF.md`, `docs/CURRENT.md`와 `docs/design/v3/ROLL20_TABLE_SPEC.md`의 결정 기록(D1~D220).
