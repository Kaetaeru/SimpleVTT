...
current_spec: docs/design/v3/ROLL20_TABLE_SPEC.md   # 요소 전수 + 결정 기록 D1~D200, 로드맵 R1~R65
...
3. `docs/HANDOFF.md`, `docs/CURRENT.md`와 `docs/design/v3/ROLL20_TABLE_SPEC.md`의 결정 기록(D1~D200).
