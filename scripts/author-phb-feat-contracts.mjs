...
const FEATS = {
  ...
  charger: { rules: [ask("질주 행동 동안 이동 속도 +10")], pre: [rider({ scope: "melee" }, [{ kind: "damage.apply", dice: "1d8", damageType: "weapon", target: "attack-target" }, ask("대상을 향해 직선으로 10피트 이상 이동했을 때 — 대신 10피트 밀기를 골라도 됩니다")])] },
  ...
  "crossbow-expert": { rules: [ask("쇠뇌의 장전 속성 무시"), ask("적에게 붙어 있어도 쇠뇌 공격에 불리 없음")] },
  ...
  "defensive-duelist": { guards: [guard([modify("ac.bonus", { value: PB }), ask("기교 무기를 들고 근접 공격에 맞았을 때만")])] },
  ...
  "great-weapon-master": { pre: [rider({ scope: "heavy" }, [{ kind: "damage.apply", amount: PB, damageType: "weapon", target: "attack-target" }, ask("자신의 턴에 공격 행동의 일부로 중량 무기를 명중시켰을 때")])], hooks: [after(["crit", "downed"], [{ kind: "economy.modify", bucket: "bonus-action.extra", amount: 1 }, ask("같은 무기로 추가 행동 공격 한 번")], "melee")] },
  ...
  interception: { rules: [ask("5피트 안의 다른 이가 맞았을 때 반응으로 피해 1d10 + 숙련 감소 — 장면에 위치가 없어 표에서 선언합니다")] },
  ...
  sharpshooter: { rules: [modify("attack-roll.ignore-cover", { value: true, scope: "ranged", note: "절반·3/4 엄폐 무시" }), ask("적에게 붙어 있어도, 장거리여도 원거리 공격에 불리 없음")] },
  ...
  "spell-sniper": { rules: [modify("attack-roll.ignore-cover", { value: true, note: "주문 공격 굴림이 절반·3/4 엄폐 무시" }), ask("적에게 붙어 있어도 주문 공격에 불리 없음"), ask("공격 굴림이 필요한 10피트 이상 주문의 사거리 +60피트")] },
  "tavern-brawler": { pre: [rider({ scope: "unarmed" }, [ask("명중시키면 대상을 5피트 밀 수 있습니다 (턴당 한 번)")])] },
