...
async function runScenario(){
  ...
  try{
    ...
    assert.equal(c12Done.resolution.attackOutcome,"명중",JSON.stringify(c12Done.resolution));assertQueuedD20(c12Done,c12Done.resolution.id,17,"MP-C12");
