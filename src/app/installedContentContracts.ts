...
export interface InstalledPortableCommonPlayMechanicV1 {
  id?:string;
  kind:"common-play";
...
export interface InstalledCatalogEntryV1 {
  ...
  /** Validated data-only Common Play mechanics. Never executable code. */
  mechanics?:InstalledPortableCommonPlayMechanicV1[];
...
declare module "./contracts" {
  interface CatalogEntry {
    ...
    sourceId?:string;
    /** Validated data-only Common Play mechanics retained for generic runtime lookup. */
    mechanics?:InstalledPortableCommonPlayMechanicV1[];
