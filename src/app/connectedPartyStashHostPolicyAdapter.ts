...
const baseCommit=MockAdapter.prototype.commitConnectedPartyStashDeposit;

MockAdapter.prototype.commitConnectedPartyStashDeposit=async function commitConnectedPartyStashDepositWithPolicy(command:PartyStashTransferCommand){
  ...
  return baseCommit.call(this,command);
};
