...
function featureActions(character:CharacterSheet):ActionVm[] {
  ...
  standardEffect("disengage","이탈","self","이번 턴 이동이 기회 공격을 유발하지 않습니다.",[detail("효과","이번 턴 기회 공격 유발 안 함"),detail("비용","행동 1"),detail("출처","SRD 5.2.1 · Disengage")],{sessionStatusEffect:{status:"이탈",target:"actor",successOutcome:"이번 턴 기회 공격을 유발하지 않음",expiresAtActorTurnBoundary:"end"}}),
  standardEffect("dodge","회피","self","다음 턴 시작까지 자신을 향한 공격에 불리, 민첩 내성에 유리.",[detail("효과","공격에 불리 · 민첩 내성에 유리"),detail("종료","자신의 다음 턴 시작"),detail("비용","행동 1"),detail("출처","SRD 5.2.1 · Dodge")],{sessionStatusEffect:{status:"회피",target:"actor",successOutcome:"다음 턴 시작까지 회피",expiresAtActorTurnBoundary:"start"}}),
  standardEffect("help","도움","ally","아군의 다음 판정 또는 공격을 돕습니다.",[detail("대상","아군 1명"),detail("효과","다음 적격 판정 또는 공격에 유리"),detail("비용","행동 1"),detail("출처","SRD 5.2.1 · Help")],{sessionStatusEffect:{status:"도움 받음",target:"first-target",successOutcome:"지원",durationKey:"helped-until-next-attack-or-check",endsOnAttack:true,endsOnCheck:true,hidden:false}}),
