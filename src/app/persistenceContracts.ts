...
export interface RulesProfileRefV1 {
  id:string;
  version:string;
}
...
export interface CharacterMaterializedCacheV1 {
...
export interface CharacterLibraryRecordV1 {
  ...
  materializedCache:CharacterMaterializedCacheV1;
}

export interface CharacterLibraryDocumentV1 {
  schemaId:typeof CHARACTER_LIBRARY_SCHEMA_ID;
  schemaVersion:typeof CHARACTER_LIBRARY_SCHEMA_VERSION;
  storageRevision:number;
  activeCharacterId:string|null;
  characters:CharacterLibraryRecordV1[];
}

export interface CharacterLibraryStoredGeneration {
  generation:number;
  payload:string|null;
  readError?:string;
}
