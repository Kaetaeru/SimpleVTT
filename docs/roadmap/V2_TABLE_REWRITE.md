...
| `T2-06` | 대부분 | 핵심 직업 자원 풀·회복, 기능 행동 14종, 분노·암습 부가 효과, 계약 마법, 소환 액터; 슬라이스 5·6: 바드의 영감(부여·사용), 불굴, 표식·강타 부가 효과, 무기 숙련 8종(베어가르기·찌르기는 타일), 야생 변신(형태의 속도), 몬스터 재충전·전설 행동·다중공격 루틴·명중 부가 효과 | 몬스터 주문 시전, 야생 변신 감각 표시 |
