...
- [x] ability-check threshold status effects commit generic economy/Effect events, connected replay, attack-ending cleanup, and Undo without a Rogue or action-ID branch;
