...
1. Start `W5-03`, the first non-`PASS` Gate in the ledger.
2. Do not reopen W1-W5-02; reuse their recorded exact-SHA evidence unless a new current-HEAD regression is reproduced.
3. For `W5-03`, inspect only the repository-defined acceptance criterion and its existing production/test owner before authorizing any product-code change.
