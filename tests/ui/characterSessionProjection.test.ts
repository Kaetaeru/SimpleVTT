...
test("Phase 13 projection carries declarative source/runtime plus qualified identities without materialized cache", () => {
...
test("Phase 13 projection rejects unsupported envelope or content-definition injection fields", () => {
  const projection=buildCharacterSessionProjectionV1(character(),catalog);
...
test("client presentation drift cannot alter the Phase 13 projection source/runtime authority payload", () => {
