...
test("Channel Divinity and Wild Shape maxima follow the exact class-table breakpoints", () => {
...
test("multiclass tracks materialize independent Channel Divinity and Wild Shape pools with one-per-Short-Rest recovery", () => {
...
test("generic ResourcePool recovery restores exactly one Channel Divinity or Wild Shape use on Short Rest and all on Long Rest", () => {
  const definitions = coreClassResourceDefinitions([
    { classId:CLERIC_ID, className:"클레릭", level:6 },
